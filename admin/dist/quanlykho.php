                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <?php
                                $sql="SELECT * FROM quantri where quantri.quyen='1' ";
                                $stm=$obj->query($sql);
                                $data=$stm->fetchALL();
                                foreach($data as $k => $v)
                                {
                            ...
                            <tbody>
                                <tr>
                                    <td><img src="assets/images/<?php echo $v['hinh']?>" alt=""></td>
                                    <td><?php echo $v['maquantri']?></td>
                                    <td><?php echo $v['Username']?></td>
                                    <td><?php echo md5($v['Passwords'])?></td>
                                    <td><?php echo $v['tenquantri']?></td>
                                    <td><?php echo $v['quyen']?></td>
                                </tr>
