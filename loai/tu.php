...
<body>
    ...
    <div  class="news-box top-margin" class="container" style="background-color: whitesmoke;">
        <marquee><h2><span style="color:red;height:20px;">Nội Thất Tủ</span></h2> </marquee>    
    </div>
    <hr>
    <!-- noi dung -->
            ...
            ?>
                <div class="col-lg-4 col-md-4 col-sm-12" style="width:400px; height:500px;">
                    <div class="newsBox">
                        <div class="thumbnail">
                           <div>
                               <a href="#"><img style="height:300px; width:300px;" src="../assets/image/phongngu/tuquanao/<?php echo $v['hinh'] ?>" alt=""></a>
                           </div>
